...
function previewFive() {
   ...
   //add appropriate src values to two new img elements
    ...
    //disable the 'Show more images' button after it has been slected once
...
function createEventListeners() {
   ...
   //the leftArrow() function will be executed when the user clicks the left navigation arow button
